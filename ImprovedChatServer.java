...
public class ImprovedChatServer {
    ...
    private static void serveQRCode(PrintWriter out) {
        ...
        String qrHtml = "" +
                ...
                "<a href=\"javascript:navigator.clipboard.writeText('" + url + "')\" class=\"btn\">Copy URL</a>" +
                "</div>" +
                "</body></html>";
    ...
    private static void serveIndex(PrintWriter out) {
        ...
        String html = "" +
                ...
                "</style></head><body>" +
                "<a href=\"/qr\" class=\"qr-link\">📱 QR Code</a>" +
